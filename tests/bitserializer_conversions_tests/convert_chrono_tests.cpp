...
const auto tp2261_05_15T10_25_15 = system_clock::from_time_t(9184357515);
...
TEST(ConvertChrono, ConvertSystemClockTimePointToUtcString) {
	...
	EXPECT_EQ(L"2261-01-15T10:25:15Z", Convert::To<std::wstring>(tp2261_05_15T10_25_15));
}
...
TEST(ConvertChrono, ConvertSystemClockTimePointWithMsToUtcString) {
	...
	EXPECT_EQ(L"2261-01-15T10:25:15.555Z", Convert::To<std::wstring>(tp2261_05_15T10_25_15 + 555ms));
}
...
TEST(ConvertChrono, ConvertUtcStringToSystemClockTimePoint) {
	...
	EXPECT_EQ(tp2261_05_15T10_25_15, Convert::To<system_clock::time_point>("2261-01-15T10:25:15Z"));
}
...
TEST(ConvertChrono, ConvertUtcStringWithMsToSystemClockTimePoint) {
	...
	EXPECT_EQ(tp2261_05_15T10_25_15 + 567ms, Convert::To<system_clock::time_point>(L"2261-01-15T10:25:15.567Z"));
}
