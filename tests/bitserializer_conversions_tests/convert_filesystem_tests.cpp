...
//-----------------------------------------------------------------------------
TEST(ConvertFilesystem, ConvertAnsiPathToAnyString) {
...
TEST(ConvertFilesystem, ConvertNativePathToUtf8) {
...
TEST(ConvertFilesystem, ConvertNativePathToWString) {
...
TEST(ConvertFilesystem, ConvertNativePathToUtf16) {
...
TEST(ConvertFilesystem, ConvertNativePathToUtf32) {
...
TEST(ConvertFilesystem, ConvertUtf8StringToPath) {
...
TEST(ConvertFilesystem, ConvertWStringToPath) {
...
TEST(ConvertFilesystem, ConvertUtf16StringToPath) {
...
TEST(ConvertFilesystem, ConvertUtf32StringToPath) {
	EXPECT_EQ(UPATH("c:/Привет Мир"), Convert::To<std::filesystem::path>(U"c:/Привет Мир").native());
	EXPECT_EQ(UPATH("c:/世界，您好"), Convert::To<std::filesystem::path>(U"c:/世界，您好").native());
}
