...
TEST(STD_PMR_Containers, SerializeSetOfSets) {
	TestSerializePmrType<ArchiveStub, std::pmr::set<std::pmr::set<int>>>();
}
...
TEST(STD_PMR_Containers, SerializeMultiSetOfMultiSets) {
	TestSerializePmrType<ArchiveStub, std::pmr::multiset<std::pmr::multiset<int>>>();
}
