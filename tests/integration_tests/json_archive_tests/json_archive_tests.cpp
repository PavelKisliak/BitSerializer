...
TEST(JsonArchive, SerializeVariantAsDiscriminatedProducesFlattenedObject)
{
...
TEST(JsonArchive, SerializeVariantAsNamedWithCustomFieldNames)
{
	using VariantType = std::variant<TestPointClass, TestClassWithSubType<int>>;
	VariantType testValue(TestPointClass(5, 8));
...
TEST(JsonArchive, SerializeVariantWithDefaultNamedModeProducesNamedObject)
{
